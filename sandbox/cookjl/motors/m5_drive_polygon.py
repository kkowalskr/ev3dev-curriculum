#!/usr/bin/env python3
"""
This module lets you integrate your work on drive_inches and turn_degrees into
 a neat application.

You will ask the user for how many sides they would like in their polygon, the
 length of each side, and a speed.
Then your robot will drive that polygon shape.

Authors: David Fisher and Pattie G., Jack C., Kenny K.
...
def main():
    ...
    while True:
        ...
        # drive a polygon with the correct number of sides. (Hint: You will add
        #  3 lines of code. What are they?).
        ...
        #
        # Observations you should make, by making library functions you can
        #  make this program in only 3 lines of code.
