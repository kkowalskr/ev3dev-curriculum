...
def main():
    ...
    while time_s != 0:
        ...
        if (distance==0):
            break
        left_motor.run_to_rel_pos(position_sp=pos,speed_sp=sp,stop_action =
        ev3.Motor.STOP_ACTION_BRAKE)
        right_motor.run_to_rel_pos(position_sp=pos,speed_sp=sp,stop_action =
        ev3.Motor.STOP_ACTION_BRAKE)
